...
%{
    ...
    */
    ...
    public static void main( String[] args ) throws Exception
    {
        ...
        lexer.init();
        System.out.println(lexer.getLexeme()+" "+lexer.getNextLexeme());
        while( lexer.getToken() != ENDOFFILE )
        {

            System.out.println("Line: "+(lexer.getCurrLine()+1)+" ,Column: "+(lexer.getCurrColumn()+1)+" ,Token: "+lexer.getToken()+": \'"+lexer.getLexeme()+"\'");
            lexer.advance();
        }
    }
